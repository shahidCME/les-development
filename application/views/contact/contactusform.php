                    ...
                    <div class="panel-body">
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                <table class="display table table-bordered table-striped dataTable" id="usersMessageList"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                            ...
                                            style="width: 100px;">Message
                                        </th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                            rowspan="1" colspan="1"
                                            aria-label="Rendering engine: activate to sort column ascending"
                                            style="width: 100px;">created at
                                        </th>
                                    </tr>
                                    </thead>
                                     <tbody role="alert" aria-live="polite" aria-relevant="all">
                                      <?php $count = 1; foreach ($meassagelist as $key => $value) { ?>
                                          <tr>
                                            <td><?=$count++?></td>
                                            <td><?=$value->fname?></td>
                                            <td><?=$value->lname?></td>
