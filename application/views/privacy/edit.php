       ...
       <?php if($this->session->flashdata('myMessage') != '' ){
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url().'admin/index'; ?>">Home</a> / <a href="<?php echo base_url().'admins/privacy_policy'; ?>">List</a> / Edit</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading"> Edit</header>
                       <form id="frmAddEdit" method="post" enctype="multipart/form-data" action="<?=base_url()?>admins/privacy_policy/update">
                       ...
                       <div class="form-group">
                        ...
                        <label for="sub_title" class="error"></label>
                         ...
                         <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <a href="<?=base_url().'admins/privacy_policy'?>" style="float: right; margin-right: 10px;" id="delete_user" class="btn btn-danger">Cancel</a>
