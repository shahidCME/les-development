    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url().'admin/index'; ?>">Home</a> / City</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading"> City</header>
                    <div class="panel-body">
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                <div class="panel-body padding-zero" style="float: right">
                                    <a href="<?php echo base_url() . 'city/city_profile'; ?>" class="btn btn-primary">Add City</a>
                                    <a href="#" id="delete_user" class="btn btn-danger">Delete City</a>
                                </div>
                                <table class="display table table-bordered table-striped dataTable" id="example_city"
                                  ...
                                  <!--   <tbody role="alert" aria-live="polite" aria-relevant="all">
                                    <?php foreach ($city_result as $result){ ?>
                                        <tr class="gradeX odd">
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() . 'city/city_profile?id=' .$this->utility->encode($result->id); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
    ...
    function single_delete(value) {
        ...
        bootbox.confirm("Are you sure you want to delete ?" , function (confirmed) {
            if (confirmed == true) {
                var id = value;
                $.ajax({
                    url: '<?php echo base_url().'city/single_delete_city'; ?>' ,
                    data: {
                        id: id
                    },
                    success: function (data) {
                        ...
                        if (data.status == 1) {
                            bootbox.alert("City has been deleted successfully.", function() {
                    ...
                    error: function () {
                        alert('Failed to delete selected city.');
                    }
                });
            }
            else
    ...
    $('#delete_user').click(function() {
        ...
        bootbox.confirm("Are you sure you want to delete ?" , function (confirmed) {
            if (confirmed == true) {
                ...
                $.ajax({
                    url: '<?php echo base_url().'city/multi_delete_city'; ?>',
