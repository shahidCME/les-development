                                    ...
                                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                                      <?php foreach ($section_two_data as $key => $value) { ?>
                                          <tr>
                                            ...
                                            <td> <a href="<?php echo base_url() . 'home_content/about_section_two/edit/'.$this->utility->safe_b64encode($value->id); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
