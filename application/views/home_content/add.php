      ...
      <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url().'admin/dashboard'; ?>">Home</a> / <a href="<?php echo base_url().'home_content'; ?>">List</a> /Add </a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                     ...
                     <form id="frmAddEdit" method="post" enctype="multipart/form-data" action="<?=base_url()?>home_content/add">
                     ...
                     <label for="image"  style="color: red" class="error"></label>
                      ...
                      <div class="form-group">
                          ...
                          <label for="name" style="color: red" class="error"><?php echo @form_error('main_title'); ?></label>
                       </div>
                        <div class="form-group">
                          <label for ="sub_title">Sub Title</label>
                              <textarea class="form-control " name="sub_title" id="sub_title"></textarea>
                          <label for="sub_title"  class="error" style="color: red"></label>
                        </div>
                      </div>
                    </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <a href="<?=base_url().'home_content'?>" style="float: right; margin-right: 10px;" id="delete_user" class="btn btn-danger">Cancel</a>
