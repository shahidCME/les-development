            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                     ...
                     <form id="frmAddEdit" method="post" enctype="multipart/form-data" action="<?=base_url()?>home_content/home_section_one_background">
                     ...
                     <?php if(@$getData[0]->image != '' ){?>
                      <div style="width: 500px;height: 300px ">
                        <div style="width: 100%;height: 100%; margin-top: 20px;" >
                            <img id="ContentImage" src="<?=base_url()?>public/uploads/home_content/<?=$getData[0]->image?>" height="100%" width="100%">
                        </div>
                      </div>
                    <?php }else{ ?>
                   ...
                   <?php } ?>
                     ...
                     <label for="image" class="error"></label>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <a href="<?=base_url().'dashboard'?>" style="float: right; margin-right: 10px;" id="delete_user" class="btn btn-danger">Cancel</a>
