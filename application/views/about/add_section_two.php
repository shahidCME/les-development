            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                     ...
                     <form id="frmAddEdit" method="post" enctype="multipart/form-data" action="<?=base_url()?>admins/about/about_section_two/add">
                     ...
                     <label for="image"  style="color: red" class="error"></label>
                      ...
                      <div class="form-group">
                          ...
                          <label for="designation" style="color: red" class="error"><?php echo @form_error('designation'); ?></label>
                       </div>
                        <div class="form-group">
