            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                     ...
                     <form id="frmAddEdit" method="post" enctype="multipart/form-data" action="<?=base_url()?>admins/web_banners/edit">
                             ...
                             <?php if(@$getAboutSectionTwo[0]->image != '' ){ ?>
                              <div style="width: 500px;height: 300px ">
                                <div style="width: 100%;height: 100%; margin-top: 20px;" >
                                    <img id="ContentImage" src="<?=base_url()?>public/images/<?=$this->folder?>web_banners/<?=$getAboutSectionTwo[0]->image?>" height="100%" width="100%">
                                </div>
                              </div>
                            <?php }else{ ?>
                      ...
                      <div class="form-group">
                          <label for="sub_title">Sub Title</label>
                            <input type="text" id="sub_title" name="sub_title" class="form-control" value="<?=$getAboutSectionTwo[0]->sub_title?>">
